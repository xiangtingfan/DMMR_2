...
if __name__ == '__main__':
    ...
    for one_subject in range(0, args.subjects):
        ...
        writer.add_scalars(tb_tag('single experiment acc'),
    ...
    writer.add_scalars(tb_tag('final experiment acc scala', 'avg'),
                       {'test acc': np.average(acc_list)})
    writer.add_scalars(tb_tag('final experiment acc scala', 'std'),
