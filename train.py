...
def trainDMMR(data_loader_dict, optimizer_config, cuda, args, iteration, writer, one_subject):
    ...
    for epoch in range(args.epoch_preTraining):
        ...
        writer.add_scalars(tb_tag('subject', one_subject + 1, 'train DMMR/loss'),
    ...
    for epoch in range(args.epoch_fineTuning):
        ...
        writer.add_scalar(tb_tag('subject', one_subject + 1, 'train DMMR/train accuracy'), acc, epoch + 1)
        print("acc: " + str(acc))
        ...
        writer.add_scalars(tb_tag('subject', one_subject + 1, 'test DMMR/test acc'),
